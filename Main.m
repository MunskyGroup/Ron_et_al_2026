...
opts.remakeFigs = true;   % Remake figures (true) or use saved (false)? NOTE: Can take half an hour or more.
...
opts.recomputeSSA = true; % Re-run a new set of SSA for each prediction of figure to be generated (full models only).
